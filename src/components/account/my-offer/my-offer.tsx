                ...
                <div className={styles.wrapperMenu}>
                  <p className="text-small-semibold">
                    {offer.offerType === "processing" && (
                      <span className={styles.colorGreen}>Ваше предложение находится в рассмотрении</span>
                    )}
                    {offer.offerType === "notReviewed" && (
                      <span className={styles.colorYellow}>Ваше предложение пока не было рассмотрено</span>
                    )}
                    {offer.offerType === "notSelected" && (
                      <span className={styles.colorPink}>К сожалению, ваше предложение не было выбрано</span>
                    )}
                  </p>
