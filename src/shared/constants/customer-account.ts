...
const thirdMenuItems = [] as unknown[];
...
const secondMenuItems = [] as unknown[];
...
const THIRD_LEVEL_MENU = { menuItems: thirdMenuItems, alias: "performer", type: "selected" };
...
export const CLIENT_ACCOUNT_MENU = [
  {
